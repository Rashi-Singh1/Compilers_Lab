...
F_DECLARATION : DATA_TYPE ID LP PARAM_LIST_WITH_DATATYPE RP SEMI{}
;
...
F_DEFINITION : DATA_TYPE ID LP PARAM_LIST_WITH_DATATYPE RP CLP STMT_LIST CRP{}
;
...
F_CALL : ID LP PARAM_LIST_WO_DATATYPE RP SEMI{}
;
