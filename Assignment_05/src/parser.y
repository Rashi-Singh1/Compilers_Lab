...
FUNC_DECLARATION : DATA_TYPE ID LP PARAM_LIST_WITH_DATATYPE RP SEMI{printf("matched function declaration\n");}
;

PARAM_LIST_WITH_DATATYPE : PARAM_WITH_DATATYPE COMMA PARAM_LIST_WITH_DATATYPE 
                         | PARAM_WITH_DATATYPE{}
;
